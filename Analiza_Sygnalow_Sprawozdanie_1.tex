...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{10_tab.jpg}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{100_tab.jpg}
		\caption{Tabela pomiarów pojemności kondensatora $100\mu F$ w zależności od parametrów $\alpha$ i $\beta$.}
	\end{figure}
	...
	\begin{itemize}
		...
		\item[$\bullet$] %coś że w 10 alfa=0.1 mało pomiarów to niedokładne przybliżenie
		\item[$\bullet$] Niedokładność obliczonej średniej nie jest w pełni wiarygodna, ponieważ pomijamy niedokładność przyrządów przyjmujemy wstępne dane jako dokładne
		...
		\item[$\bullet$] Możemy zauważyć, że jeśli wraz ze wzrostem pojemności teoretycznej zmniejszamy $\alpha$ to znajdujemy się najbliżej oczekiwanych wyników.
